...
*   [ApexUnitTestAssertStatement](pmd_rules_apex_bestpractices.html#apexunittestassertstatement): Apex test assert should have 2 params and assertEquals/assertNotEquals should have 3 params.
...
*   [ApexUnitTestMethodShouldHaveIsTestAnnotation](pmd_rules_apex_bestpractices.html#apexunittestmethodshouldhaveistestannotation): Apex test methods should have @isTest annotation either in the same line or in previous line.
