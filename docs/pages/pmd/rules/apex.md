...
*   [DebugsShouldSpecifyLoggingLevel](pmd_rules_apex_bestpractices.html#debugsshouldspecifylogginglevel): The first parameter of System.debug, when using the signature with two parameters, is a LoggingLe...
