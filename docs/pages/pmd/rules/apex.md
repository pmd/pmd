...
*   [DebugsShouldUseLoggingLevel](pmd_rules_apex_bestpractices.html#debugsshoulduselogginglevel): The first parameter of System.debug, when using the signature with two parameters, is a LoggingLe...
