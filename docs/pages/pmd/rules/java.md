...
*   [UnsynchronizedStaticMessageDigest](pmd_rules_java_multithreading.html#unsynchronizedstaticmessagedigest): MessageDigest::digest is not synchronized. We should use separate format instances            for...
