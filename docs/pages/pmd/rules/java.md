...
*   [DetachedTestCase](pmd_rules_java_errorprone.html#detachedtestcase): The method appears to be a test case since it has public or default visibility,non-static access,...
...
*   [AvoidApacheCommonsFileItemNonStreaming](pmd_rules_java_performance.html#avoidapachecommonsfileitemnonstreaming): Problem: Use of FileItem.get and FileItem.getString could exhaust memory since they load the enti...
...
*   [AvoidCalendarDateCreation](pmd_rules_java_performance.html#avoidcalendardatecreation): Problem: A Calendar is a heavyweight object and expensive to create.             Solution: Use 'n...
*   [AvoidConcatInAppend](pmd_rules_java_performance.html#avoidconcatinappend): Concatenation of Strings is used inside an StringBuilder.append argument. Problem: Each statement...
*   [AvoidConcatInLoop](pmd_rules_java_performance.html#avoidconcatinloop): A String is built in a loop by concatenation. Problem: Each statement with one or more +-operator...
