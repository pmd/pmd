...
*   [AvoidMessageDigestField](pmd_rules_java_bestpractices.html#avoidmessagedigestfield): Declaring a MessageDigest instance as a field make this instance directly available to multiple t...
...
*   [MoreThanOneLogger](pmd_rules_java_errorprone.html#morethanonelogger): Normally only one logger is used in each class. This rule supports slf4j, log4j, Java Util Loggin...
...
*   [DoNotUseThreads](pmd_rules_java_multithreading.html#donotusethreads): The J2EE specification explicitly forbids the use of threads. Threads are resources, that should ...
