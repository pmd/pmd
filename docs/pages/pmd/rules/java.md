...
*   [AvoidMessageDigestField](pmd_rules_java_bestpractices.html#avoidmessagedigestfield): Since Java5 brought a new implementation of the Map designed for multi-threaded access, you can  ...
