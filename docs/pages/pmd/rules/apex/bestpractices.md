...
Apex test assert should have 2 params and assertEquals/assertNotEquals should have 3 params.
...
public class Foo {
    ...
    static void methodATest() {
        ...
        System.assertEquals('123', o.StageName, o); // good
        System.assert(1==1); // not good
        System.assert(1==1, 2); // good
    }
}
```
...
Apex test methods should have @isTest annotation either in the same line or in previous line.
