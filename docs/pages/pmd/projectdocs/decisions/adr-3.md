...
* Any package that contains an `internal` segment is considered internal. E.g. `net.sourceforge.pmd.internal`.
  *Internal API* is meant for use *only* by the main PMD codebase. Internal types and methods
  ...
  The javadoc tag `@apiNote Internal API. None of this is published API, and compatibility can be broken anytime! Use this only at your own risk.`
...
2026-01-08: Added details on how to use javadoc tags for deprecated, experimental and internal APIs.
