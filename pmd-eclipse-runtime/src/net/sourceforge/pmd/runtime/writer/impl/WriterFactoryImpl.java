...
import net.sourceforge.pmd.runtime.writer.IWriterFactory;
...
public class WriterFactoryImpl implements IWriterFactory {
    ...
    /**
     * @see net.sourceforge.pmd.runtime.writer.IWriterFactory#getRuleSetWriter()
     */
    ...
    /**
     * @see net.sourceforge.pmd.runtime.writer.IWriterFactory#getAstWriter()
     */
