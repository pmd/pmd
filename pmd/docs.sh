...
if [ -z $option ]; then
  ...
  mvn -q deploy:deploy-file -Durl=scp://pmd.sourceforge.net/home/groups/p/pm/pmd/htdocs/maven2.beta -DrepositoryId=pmd-repo -Dfile=java14/lib/pmd14-4.2rc1.jar -DpomFile=pmd-jdk14-pom.xml
