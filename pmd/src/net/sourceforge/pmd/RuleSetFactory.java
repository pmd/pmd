...
public class RuleSetFactory {
     ...
     *********************************************************************************
     *
     * Converts a list of rule set names into file names, builds a property value, stores
     * the value into a Properties, and stores the Properties.
     *
     * @param ruleSetNames A list of the rule set names to be written to the rulesets.properties file.
     */
    public void saveRegisteredRuleSetFileNames(String directory, List ruleSetNames)
        throws FileNotFoundException, IOException
    {
        StringBuffer buffer = new StringBuffer(200);
        Iterator iterator = ruleSetNames.iterator();

        while (iterator.hasNext())
        {
            buffer.append("rulesets/");
        ...
        String fileName = directory + File.separatorChar + "rulesets.txt";
        ...
        try
        {
            ...
            properties.put("rulesets.filenames", fileNames);
