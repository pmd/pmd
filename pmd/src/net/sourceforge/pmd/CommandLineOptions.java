...
public class CommandLineOptions {
    ...
    public String usage() {
        return PMD.EOL + PMD.EOL +
            ...
            PMD.EOL +
            "For example: " + PMD.EOL +
            "c:\\> java -jar pmd-1.7.jar c:\\my\\source\\code html rulesets/unusedcode.xml,rulesets/imports.xml" + PMD.EOL +
            PMD.EOL +
            ...
            PMD.EOL +
            "For example: " + PMD.EOL +
            "c:\\> java -jar pmd-1.7.jar c:\\my\\source\\code html rulesets/unusedcode.xml,rulesets/imports.xml -jdk13 -debug" + PMD.EOL +
            "c:\\> java -jar pmd-1.7.jar c:\\my\\source\\code html rulesets/unusedcode.xml,rulesets/imports.xml -encoding UTF-8" + PMD.EOL +
            PMD.EOL;
    }
}
