 ...
 /*@bgen(jjtree) VariableDeclaratorId */
  ...
  Token t = null;
    ...
    if (!usingAssertAsIdentifier && s.equals("assert")) {
      {if (true) throw new ParseException("Can't use 'assert' as an identifier when running in JDK 1.4 mode!");}
    }
    jjtn000.setImage( s );
    } finally {
    if (jjtc000) {
