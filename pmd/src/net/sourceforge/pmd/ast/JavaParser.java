 ...
 /*@bgen(jjtree) Literal */
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case INTEGER_LITERAL:
  String intValue = ""; Token t = null;
        t = jj_consume_token(INTEGER_LITERAL);
  intValue=t.image;
                       jjtree.closeNodeScope(jjtn000, true);
                       jjtc000 = false;
                      jjtn000.setImage(intValue);
        break;
      case FLOATING_POINT_LITERAL:
  String floatValue = "";
 ...
 /*@bgen(jjtree) LocalVariableDeclaration */
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      case FINAL:
        jj_consume_token(FINAL);
             ((ASTLocalVariableDeclaration)jjtn000).setIsFinal();
        break;
      default:
        jj_la1[93] = jj_gen;
        ;
...
jjtree.openNodeScope(jjtn000);boolean hasElse = false;
 ...
 /*@bgen(jjtree) TryStatement */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);boolean hasCatch = false;
