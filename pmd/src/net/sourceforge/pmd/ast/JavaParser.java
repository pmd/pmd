 ...
 /*@bgen(jjtree) UnmodifiedClassDeclaration */
  ...
  jjtree.openNodeScope(jjtn000);Token t = null;
    try {
     ...
     ((ASTUnmodifiedClassDeclaration) jjtn000).setClassName( t.image );
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case EXTENDS:
      ...
      while (true) {
        ...
        case TRANSIENT:
          jj_consume_token(TRANSIENT);
                          ((AccessNode) jjtn000).setTransient( true );
          break;
        case VOLATILE:
          jj_consume_token(VOLATILE);
                          ((AccessNode) jjtn000).setVolatile( true );
          break;
        default:
          jj_la1[23] = jj_gen;
          jj_consume_token(-1);
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      while (true) {
        ...
        case NATIVE:
          jj_consume_token(NATIVE);
                          ((AccessNode) jjtn000).setNative( true );
          break;
        case SYNCHRONIZED:
          jj_consume_token(SYNCHRONIZED);
                          ((AccessNode) jjtn000).setSynchronized( true );
          break;
        case STRICTFP:
          jj_consume_token(STRICTFP);
                          ((AccessNode) jjtn000).setStrict( true );
