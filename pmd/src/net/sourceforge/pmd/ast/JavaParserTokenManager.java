...
public class JavaParserTokenManager implements JavaParserConstants {
    ...
    private final int jjStopStringLiteralDfa_0(int pos, long active0, long active1) {
        switch (pos) {
            case 0:
                ...
                if ((active0 & 0x100L) != 0L || (active1 & 0x2004000000000L) != 0L)
                    return 49;
                return -1;
            case 1:
                if ((active0 & 0x201800000L) != 0L)
                    return 28;
                if ((active0 & 0xfffffffdfe7ff000L) != 0L) {
                    if (jjmatchedPos != 1) {
                        jjmatchedKind = 72;
                        jjmatchedPos = 1;
                    }
            ...
            case 2:
                if ((active0 & 0x400026080000000L) != 0L)
                    return 28;
                if ((active0 & 0xfbfffd9d7f7ff000L) != 0L) {
                    if (jjmatchedPos != 2) {
                        jjmatchedKind = 72;
                        jjmatchedPos = 2;
                    }
                ...
                return -1;
            case 3:
                if ((active0 & 0xf1dff95c7d7a7000L) != 0L) {
                    jjmatchedKind = 72;
                    jjmatchedPos = 3;
                    return 28;
                }
            ...
            case 4:
                if ((active0 & 0x20c50000781a4000L) != 0L)
                    return 28;
                if ((active0 & 0xd11af95c05603000L) != 0L) {
                    if (jjmatchedPos != 4) {
                        jjmatchedKind = 72;
                        jjmatchedPos = 4;
                    }
                ...
                return -1;
            case 5:
                if ((active0 & 0x808ac10801000000L) != 0L)
                    return 28;
    ...
    private final int jjMoveStringLiteralDfa0_0() {
        switch (curChar) {
            ...
            case 47:
                jjmatchedKind = 102;
                return jjMoveStringLiteralDfa1_0(0x100L, 0x2000000000000L);
            case 58:
            ...
            case 97:
                return jjMoveStringLiteralDfa1_0(0x8000000000001000L, 0x0L);
            case 98:
    ...
    private final int jjMoveStringLiteralDfa2_0(long old0, long active0, long old1, long active1) {
        ...
        switch (curChar) {
            ...
            case 115:
                return jjMoveStringLiteralDfa3_0(active0, 0x8000001002011000L, active1, 0L);
            case 116:
    ...
    private final int jjMoveStringLiteralDfa3_0(long old0, long active0, long old1, long active1) {
        ...
        switch (curChar) {
            ...
            case 101:
                ...
                return jjMoveStringLiteralDfa4_0(active0, 0x8004004004000000L, active1, 0L);
            case 103:
    ...
    private final int jjMoveStringLiteralDfa4_0(long old0, long active0, long old1, long active1) {
        ...
        switch (curChar) {
            ...
            case 114:
                ...
                return jjMoveStringLiteralDfa5_0(active0, 0x8000804800001000L);
            case 115:
    ...
    static final long[] jjtoToken = {0xfffffffffffff001L, 0x1fffffffffff9d1L, };
    static final long[] jjtoSkip = {0x67eL, 0x0L, };
    static final long[] jjtoSpecial = {0x67eL, 0x0L, };
    static final long[] jjtoMore = {0x980L, 0x0L, };
