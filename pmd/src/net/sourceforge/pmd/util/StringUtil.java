...
public class StringUtil {
     ...
     * @param trim Indicates if the case of the Strings should ignored during comparison.
     * @param trim Indicates if the embedded whitespace should be standardized before comparison.
