 ...
 * 
 * Textblocks are marked in Velocity with #[[content here]]# notation. Velocity will output everything between the
 * markers and does not attempt to parse it in any way.
 */
public class ASTTextblock extends SimpleNode {
     ...
     * @param id
     */
    public ASTTextblock(final int id) {
        super(id);
    }
     ...
     * @param id
     */
    public ASTTextblock(final VmParser p, final int id) {
        super(p, id);
    }
