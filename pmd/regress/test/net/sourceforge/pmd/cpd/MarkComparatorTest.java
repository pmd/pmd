...
public class MarkComparatorTest extends TestCase {
    ...
    public void testEqualMarksAreEqual() {
        List code = getCode();
        MarkComparator comp = new MarkComparator(new CPDNullListener(), code, 1);
        Mark mark1 = new Mark(code.size(), "/var/Foo.java", 1);
        Mark mark6 = new Mark(code.size(), "/var/Foo.java", 1);
    ...
    public void testUnuequalMarksAreUnequal() {
        List code = getCode();
        MarkComparator comp = new MarkComparator(new CPDNullListener(), code, 1);
        Mark mark1 = new Mark(0, "/var/Foo.java", 1);
        Mark mark5 = new Mark(4, "/var/Foo.java", 1);
