...
public class ReportTest extends TestCase implements ReportListener {
    ...
    public void testBasic() {
        ...
        r.addRuleViolation(new RuleViolation(new MockRule("name", "desc", "msg", "rulesetname"), 5, ctx, "package", "class"));
    ...
    public void testSortedReport_File() {
        ...
        RuleContext ctx = new RuleContext();
        ctx.setSourceCodeFilename("foo");
        r.addRuleViolation(new RuleViolation(new MockRule("name", "desc", "msg", "rulesetname"), 10, ctx, "package", "class"));
        ctx.setSourceCodeFilename("bar");
        r.addRuleViolation(new RuleViolation(new MockRule("name", "desc", "msg", "rulesetname"), 20, ctx, "package", "class"));
    ...
    public void testSortedReport_Line() {
        ...
        r.addRuleViolation(new RuleViolation(new MockRule("rule2", "rule2", "msg", "rulesetname"), 10, ctx, "package", "class"));
        ctx.setSourceCodeFilename("foo2");
        r.addRuleViolation(new RuleViolation(new MockRule("rule1", "rule1", "msg", "rulesetname"), 20, ctx, "package", "class"));
        Renderer rend = new XMLRenderer();
        String result = rend.render(r);
    ...
    public void testListener() {
        ...
        rpt.addRuleViolation(new RuleViolation(new MockRule("name", "desc", "msg", "rulesetname"), 5, ctx, "package", "class"));
    ...
    public void testSummary() {
        ...
        r.addRuleViolation(new RuleViolation(mr, 20, ctx, "package", "class"));
        r.addRuleViolation(new RuleViolation(mr, 30, ctx, "package", "class"));
