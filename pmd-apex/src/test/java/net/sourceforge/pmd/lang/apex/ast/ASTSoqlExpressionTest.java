...
class ASTSoqlExpressionTest extends ApexParserTestBase {
    ...
    void testQuery1() {
        ...
        ASTSoqlExpression soqlExpression =
                root.descendants(ASTSoqlExpression.class).firstOrThrow();
    ...
    void testQuery3() {
        ...
        assertEquals(
                "SELECT Name FROM Account WHERE Id = :tmpVar1 AND Name = :tmpVar2", soqlExpression.getCanonicalQuery());
    }
}
