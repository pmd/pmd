...
public final class ASTUserInterface extends BaseApexClass<InterfaceDeclaration>
        implements ASTUserClassOrInterface<InterfaceDeclaration> {
    ...
    public String getSuperInterfaceName() {
        return node.getExtendsTypes().stream()
