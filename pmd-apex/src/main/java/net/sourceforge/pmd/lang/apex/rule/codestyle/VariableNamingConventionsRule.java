...
public class VariableNamingConventionsRule extends AbstractApexRule {
    ...
    private static final PropertyDescriptor<Boolean> CHECK_MEMBERS_DESCRIPTOR = booleanProperty("checkMembers").desc("Check member variables").defaultValue(true).build();

    private static final PropertyDescriptor<Boolean> CHECK_LOCALS_DESCRIPTOR = booleanProperty("checkLocals").desc("Check local variables").defaultValue(true).build();

    private static final PropertyDescriptor<Boolean> CHECK_PARAMETERS_DESCRIPTOR = booleanProperty("checkParameters").desc("Check constructor and method parameter variables").defaultValue(true).build();
