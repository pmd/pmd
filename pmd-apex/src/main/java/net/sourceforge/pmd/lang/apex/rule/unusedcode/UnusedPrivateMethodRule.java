...
import net.sourceforge.pmd.lang.apex.ast.ASTInitializer;
import net.sourceforge.pmd.lang.apex.ast.ASTMethod;
import net.sourceforge.pmd.lang.apex.rule.AbstractApexRule;
import net.sourceforge.pmd.lang.apex.symboltable.ClassScope;
import net.sourceforge.pmd.lang.apex.symboltable.MethodNameDeclaration;
 ...
 */
public class UnusedPrivateMethodRule extends AbstractApexRule {
    ...
    private boolean privateAndNotExcluded(NameDeclaration mnd) {
        ASTMethod node = (ASTMethod) mnd.getNode();
