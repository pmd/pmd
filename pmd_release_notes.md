...
* The new java rule [`DanglingJavadoc`](https://docs.pmd-code.org/pmd-doc-7.17.0-SNAPSHOT/pmd_rules_java_documentation.html#danglingjavadoc) finds Javadoc comments that
...
See [Report formats for CPD](https://docs.pmd-code.org/pmd-doc-7.17.0-SNAPSHOT/pmd_userdocs_cpd_report_formats.html#markdown).
