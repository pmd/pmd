...
public class VfHtmlXssStyleTagUrlPatternMatchingTest {
    ...
    public void testUrlMethodPatternMatchForPositive() {
        ...
        assertTrue("Sample should be considered as starting a URL method: " + sampleString, rule.isWithinUrlMethod(sampleString));
    }
    ...
    public void testUrlMethodPatternMatchForClosedUrl() {
        ...
        assertFalse("Sample should not be considered as starting a URL method: " + sampleString, rule.isWithinUrlMethod(sampleString));
    }
