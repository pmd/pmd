...
public class XPathJspRuleTest extends RuleTst {
    ...
    public void testExpressionMatching() throws PMDException {
        ...
        rule.setLanguage(LanguageRegistry.getLanguage(VfLanguageModule.NAME));
        ...
        ctx.setLanguageVersion(LanguageRegistry.getLanguage(VfLanguageModule.NAME).getDefaultVersion());
