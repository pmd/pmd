...
class Java11Test : ParserTestSpec({
    ...
    testGroup("var keyword should be a normal type pre-java 11", javaVersions = J1_8..J10) {
    ...
    testGroup("var keyword should generate no type after java 11", javaVersions = J11..Latest) {
