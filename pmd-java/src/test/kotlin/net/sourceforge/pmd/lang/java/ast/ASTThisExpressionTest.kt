 ...
 * @since 7.0.0
 */
class ASTThisExpressionTest :
    ParserTestSpec({
        parserTestContainer("Unqualified this") {
            inContext(ExpressionParsingCtx) { "this" should parseAs { thisExpr { null } } }
        }

        parserTestContainer("Qualified this") {
            inContext(ExpressionParsingCtx) {
                "Type.this" should parseAs { thisExpr { classType("Type") } }

                "net.sourceforge.pmd.lang.java.ast.ASTThisExpression.this" should
                    parseAs {
                        thisExpr {
        ...
        parserTestContainer("This/cast lookahead bug in parens") {
            ...
            """
                    ...
                    parseAs {
                        castExpr {
                            classType("Set") { unspecifiedChild() }
                            parenthesized { child<ASTConstructorCall>(ignoreChildren = true) {} }
                        }
                    }
            ...
            """
                    ...
                    parseAs {
                        castExpr {
                            classType("Set") { unspecifiedChild() }
                            parenthesized { child<ASTThisExpression>(ignoreChildren = true) {} }
                        }
                    }
