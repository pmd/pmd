...
class JMethodSigTest :
    ProcessorTestSpec({
        ...
        """
            ...
            spy.shouldBeOk {
                val m =
                    acu.declaredMethodSignatures()[0].also {
                        ...
                        it.toString() shouldBe
                            "p.Foo<A, B extends java.lang.Number>.<T, E extends java.lang.RuntimeException> method(A, B extends java.lang.Number) -> T"
                    }
                ...
                m.erasure.also {
                    ...
                    it.toString() shouldBe
                        "p.Foo.method(java.lang.Object, java.lang.Number) -> java.lang.Object"
                }
            }
        }
    })
