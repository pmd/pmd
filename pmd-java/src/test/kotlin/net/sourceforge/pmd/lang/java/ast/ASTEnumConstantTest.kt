                ...
                "enum Foo { , }" should
                    parseAs {
                        enumDecl("Foo") {
                            ...
                            enumBody { it::hasTrailingComma shouldBe true }
                        }
                    }
                            ...
                            enumBody {
                                enumConstant("B") {
                                    ...
                                    it::getModifiers shouldBe
                                        modifiers {
                                            c::declaredAnnotationsList shouldBe
                                                listOf(annotation("C"))
                                        }
                                ...
                                enumConstant("C") {
                                    ...
                                    it::getModifiers shouldBe
                                        modifiers {
                                            c::declaredAnnotationsList shouldBe
                                                listOf(annotation("A"), annotation("a"))
                                        }
                                ...
                                enumConstant("B") {
                                    it::getModifiers shouldBe
                                        modifiers {
                                            ...
                                            it.effectiveModifiers.shouldContainExactly(
                                                setOf(PUBLIC, STATIC, FINAL)
                                            )
                                        }
                                    ...
                                    it::getArguments shouldBe child { stringLit("\"str\"") }
