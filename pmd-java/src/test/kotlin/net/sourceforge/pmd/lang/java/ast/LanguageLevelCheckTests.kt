...
class LanguageLevelCheckTests :
    ParserTestSpec({
        ...
        parserTestContainer(
            "Reserved 'var' identifier (pre java-10)",
            javaVersions = Earliest..J9,
        ) {
            inContext(TopLevelTypeDeclarationParsingCtx) { "/*Top*/ class var { }" should parse() }
