...
class ASTExplicitConstructorInvocationTest :
    ParserTestSpec({
        ...
        parserTestContainer("Explicit super invocation with LHS") {
            inContext(TypeBodyParsingCtx) {
                ...
                "Foo() { o.<S>foo().<String>super(); }" should
                    parseAs {
                        constructorDecl {
                            it::getModifiers shouldBe modifiers {}
                ...
                "public TabbedPaneLayout() { MetalTabbedPaneUI.this.super(); }" should
                    parseAs {
                        constructorDecl {
            ...
            // An explicit constructor invocation statement in a constructor body may not refer to
            // any instance
            // variables or instance methods or inner classes declared in this class or any
            // superclass, or use
