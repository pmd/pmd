                ...
                "@F(\"ohio\")" should
                    parseAs {
                        child<ASTAnnotation> {
                            ...
                            it::getMemberList shouldBe
                                child { shorthandMemberValue { stringLit("\"ohio\"") } }
                        }
                    }

                "@org.F({java.lang.Math.PI})" should
                    parseAs {
                        child<ASTAnnotation> {
                            it::getSimpleName shouldBe "F"
                ...
                "@org.F(@Oh)" should
                    parseAs {
                        child<ASTAnnotation> {
                            ...
                            it::getMemberList shouldBe
                                child { shorthandMemberValue { annotation("Oh") } }
                        }
                    }
            }
        }
                ...
                "@F(a=\"ohio\")" should
                    parseAs {
                        child<ASTAnnotation> {
                            ...
                            it::getMemberList shouldBe
                                child { memberValuePair("a") { stringLit("\"ohio\"") } }
                        }
                    }

                "@org.F(a={java.lang.Math.PI}, b=2)" should
                    parseAs {
                        child<ASTAnnotation> {
                            it::getSimpleName shouldBe "F"
                            ...
                            it::getMemberList shouldBe
                                child {
                                    memberValuePair("a") {
                                        child<ASTMemberValueArrayInitializer> {
                                            fieldAccess("PI") { ambiguousName("java.lang.Math") }
                                        }
                                    }

                                    memberValuePair("b") { number() }
                                }
                        }
                    }
