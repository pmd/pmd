...
class SuperTypesEnumeratorTest :
    ParserTestSpec({
        ...
        """
            ...
            doTest("ALL_SUPERTYPES_INCLUDING_SELF") {
                with(acu.typeDsl) {
                    ...
                    ALL_SUPERTYPES_INCLUDING_SELF.list(sup) should
                        containExactly(sup, ts.OBJECT, i2, i1)
                    ALL_SUPERTYPES_INCLUDING_SELF.list(sub) should
                        containExactly(sub, sup, ts.OBJECT, i1, i2)
                }
            }
            ...
            doTest("SUPERCLASSES_AND_SELF") {
                ...
                SUPERCLASSES_AND_SELF.list(sub) should
                    containExactly(sub, sup, sup.typeSystem.OBJECT)
            }
        }
    })
