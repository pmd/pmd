...
class ASTNumericLiteralTest {
    ...
    void testParseLongBinary() {
        ...
        long parsedLong = ASTNumericLiteral.parseIntegralValue(
                Chars.wrap("0b0000000000000000000000000000000000000000100010001000010000010000L"));
    ...
    void malformedLiteral() {
        ...
        assertEquals(
                0L, ASTNumericLiteral.parseIntegralValue(Chars.wrap("0x1_0000_0000_0000_0000L"))); // too big, 65bits
    }
}
