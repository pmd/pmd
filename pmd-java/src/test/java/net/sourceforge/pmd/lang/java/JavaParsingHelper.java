...
public class JavaParsingHelper extends BaseParsingHelper<JavaParsingHelper, ASTCompilationUnit> {
    ...
    /**
     * Note: this is the default type system for everything parsed with default options of JavaParsingHelper. This
     * allows constants like the null type to be compared.
     */
    ...
    public static final JavaParsingHelper DEFAULT =
            new JavaParsingHelper(Params.getDefault(), SemanticErrorReporter.noop(), // todo change this to unforgiving
                                                                                     // logger, need to update a lot of
                                                                                     // tests
    ...
    /**
     * Will throw on the first semantic error or warning. Useful because it produces a stack trace for that
     * warning/error.
     */
