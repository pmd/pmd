...
class Java22TreeDumpTest extends BaseJavaTreeDumpTest {
    private final JavaParsingHelper java22 = JavaParsingHelper.DEFAULT
            .withDefaultVersion("22")
    ...
    void jep456UnnamedPatternsAndVariablesBeforeJava22() {
        ParseException thrown = assertThrows(
                ParseException.class, () -> java21.parseResource("Jep456_UnnamedPatternsAndVariables.java"));
        assertThat(
                thrown.getMessage(),
                containsString(
                        "Unnamed variables and patterns are a feature of Java 22, you should select your language version accordingly"));
    }
    ...
    void jep456UnnamedVariablesAndPatternsUnderscoreBeforeJava21() {
        ParseException thrown = assertThrows(
                ...
                () -> java17.parse("class Test { { for(Integer _ : java.util.Arrays.asList(1, 2, 3)) {} } }"));
        assertThat(
                thrown.getMessage(),
                containsString("Since Java 9, '_' is reserved and cannot be used as an identifier"));
    }
}
