...
/**
 * A lexical literal. This is an expression that is represented by exactly one token. This interface is implemented by
 * several nodes.
 *
 * <pre class="grammar">
 *
...
public interface ASTLiteral extends ASTPrimaryExpression {
    /**
     * Return the text of the literal in the source file. Note that {@link #getText()} may include parentheses.
     */
