 ...
 *
 * <p>
 * This implements JTypeMirror for convenience, however, it may only occur as a
 * type argument, and as such some of the behaviour of JTypeMirror is undefined:
 * {@link #isSubtypeOf(JTypeMirror) subtyping} and {@link #getErasure()
 * erasure}.
 */
public interface JWildcardType extends JTypeMirror {
    ...
    /**
     * Returns true if this is an "extends" wildcard, the bound is then an upper
     * bound.
     */
    ...
    /**
     * This is implemented for convenience. However, the erasure of a wildcard type
     * is undefined and useless. This is because they can only occur in type
     * arguments, which are erased themselves.
     */
    @Override
