...
/**
 * Internal API of {@link JMethodSig}. These methods are internal to the
 * inference framework.
 */
public interface InternalMethodTypeItf {
    ...
    /**
     * Returns a new method type with the given return type and all the same
    ...
    /**
     * Returns a new method type with the given type parameters. Nothing is done to
     * the other types presented by this object. If null, resets them to the value
     * of the symbol (but this takes care of the enclosing type subst in bounds).
     */
