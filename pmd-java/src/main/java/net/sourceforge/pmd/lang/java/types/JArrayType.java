...
public final class JArrayType implements JTypeMirror {
    ...
    /**
     * Gets the component type of this array. This is the same type as the array, stripped of a single array dimensions,
     * e.g. the component type of {@code int[][][]} is {@code int[][]}.
     *
    ...
    /**
     * Gets the element type of this array. This is the same type as the array, stripped of all array dimensions, e.g.
     * the element type of {@code int[][][]} is {@code int}.
     *
