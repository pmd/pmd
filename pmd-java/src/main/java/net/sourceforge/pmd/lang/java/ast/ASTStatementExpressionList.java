...
/**
 * A list of statement expressions. Statement expressions are those expressions which can appear in an
 * {@linkplain ASTExpressionStatement expression statement}.
 *
 *
 * <p>
 * Statement expression lists occur only {@link ASTForInit} and {@link ASTForUpdate}. To improve the API of
 * {@link ASTForInit}, however, this node implements {@link ASTStatement}.
 *
 * <pre class="grammar">
 *
