...
/**
 * Groups a variable ID and its initializer if it exists. May be found as a
 * child of {@linkplain ASTFieldDeclaration field declarations} and
 * {@linkplain ASTLocalVariableDeclaration local variable declarations}.
 *
 * <p>
 * The {@linkplain #getInitializer() initializer} is the only place
...
public class ASTVariableDeclarator extends AbstractJavaNode implements InternalInterfaces.VariableIdOwner {
    ...
    /**
     * Returns true if the declared variable is initialized. Otherwise,
     * {@link #getInitializer()} returns null.
     */
