...
/**
 * A class instance creation expression. Represents both
 * {@linkplain #isQualifiedInstanceCreation() qualified} and unqualified
 * instance creation. May declare an anonymous class body.
 *
 *
 * <pre class="grammar">
 *
...
public final class ASTConstructorCall extends AbstractInvocationExpr
    ...
    /**
     * Returns true if this expression begins with a primary expression. Such an
     * expression creates an instance of inner member classes and their anonymous
     * subclasses. For example, {@code new Outer().new Inner()} evaluates to an
     * instance of the Inner class, which is nested inside the new instance of
     * Outer.
     */
    ...
    /**
     * Returns the outer instance expression, if this is a
     * {@linkplain #isQualifiedInstanceCreation() qualified} constructor call.
     * Otherwise returns null. This can never be a {@linkplain ASTTypeExpression
     * type expression}, and is never {@linkplain ASTAmbiguousName ambiguous}.
     */
    @Override
    ...
    /**
     * Returns true if type arguments to the constructed instance's type are
     * inferred.
     */
    ...
    /**
     * Returns true if this expression defines a body, which is compiled to an
     * anonymous class. Otherwise, this method returns false.
     */
