...
public class JavaLanguageProperties extends JvmLanguagePropertyBundle {
    ...
    static final PropertyDescriptor<InferenceLoggingVerbosity> INTERNAL_INFERENCE_LOGGING_VERBOSITY =
            PropertyFactory.enumProperty("xTypeInferenceLogging", EnumUtils.getEnumMap(InferenceLoggingVerbosity.class))
     ...
     * @since 7.5.0
     */
    static final PropertyDescriptor<Boolean> INTERNAL_DO_STRICT_TYPERES = PropertyFactory.booleanProperty(
                    "xStrictTypeRes")
