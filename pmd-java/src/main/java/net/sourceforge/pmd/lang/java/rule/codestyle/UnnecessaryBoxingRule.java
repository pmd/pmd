...
public class UnnecessaryBoxingRule extends AbstractJavaRulechainRule {
    ...
    private void checkBox(RuleContext rctx, ASTExpression conversionExpr, ASTExpression convertedExpr) {
        ...
        // (here we do sourceExpr=Integer (-> convInput=Integer) -> convOutput=byte ->
        // ctx=int).
    ...
    private void checkUnboxing(RuleContext rctx, ASTMethodCall methodCall, JTypeMirror conversionOutput) {
        ...
        // this checks, whether the resulting type "Integer" is e.g. assigned to an
        // "int"
    ...
    /**
     * Type of the converted i in context ctx. If no implicit conversion is possible
     * then return null.
     */
    ...
    /**
     * Whether the explicit conversion from i to o changes the value. This is e.g.
