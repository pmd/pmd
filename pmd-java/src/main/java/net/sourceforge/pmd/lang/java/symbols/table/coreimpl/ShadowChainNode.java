...
/**
 * A {@link ShadowChain} viewed as individual nodes. This offers a lower level API as {@link ShadowChain}.
 */
public interface ShadowChainNode<S, I> {

    /**
     * Returns true if this group shadows the next groups in the chain. This means, that if this group knows about a
     * name, it won't delegate resolve to the next group in the chain. If it doesn't know about it then resolve proceeds
     * anyway.
     */
    ...
    /**
     * Wraps {@link #getResolver()}{@code .resolveHere()}, may do additional stuff like caching.
     */
