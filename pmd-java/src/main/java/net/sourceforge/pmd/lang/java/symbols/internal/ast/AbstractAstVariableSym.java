...
abstract class AbstractAstVariableSym extends AbstractAstAnnotableSym<ASTVariableId> implements JVariableSymbol {
    ...
    public JTypeMirror getTypeMirror(Substitution subst) {
         ...
         * 
         * This gives up on inferred types until a LazyTypeResolver has been set for the
         * compilation unit.
         * 
         * Thankfully, the type of local vars is never requested by anything before that
         * moment.
         */
