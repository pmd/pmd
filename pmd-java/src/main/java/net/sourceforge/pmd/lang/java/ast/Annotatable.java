...
/**
 * Marks nodes that can be annotated. {@linkplain ASTAnnotation Annotations} are most often the first few children of
 * the node they apply to. E.g. in {@code @Positive int}, the {@code @Positive} annotation is a child of the
 * {@link ASTPrimitiveType PrimitiveType} node. This contrasts with PMD 6.0 grammar, where the annotations were most
 * often the preceding siblings.
 */
public interface Annotatable extends JavaNode {
     ...
     *
     * @param binaryName
     *            Binary name of the annotation type. Note: for now, canonical names are tolerated, this may be changed
     *            in PMD 7.
     */
     ...
     *
     * @param binaryNames
     *            Collection that contains binary names of annotations. Note: for now, canonical names are tolerated,
     *            this may be changed in PMD 7.
