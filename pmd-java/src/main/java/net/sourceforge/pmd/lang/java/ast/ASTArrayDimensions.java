 ...
 * <li>As the {@linkplain ASTMethodDeclaration#getExtraDimensions() extra
 * dimensions of a method declaration}, after the formal parameter list. For
 * example:
 * 
 * <pre>
 ...
 * 
 * </li>
 * <li>As the {@linkplain ASTVariableId#getExtraDimensions() extra dimensions of
 * a variable declarator id}, in a {@linkplain ASTVariableDeclarator variable
 ...
 *
 * <p>
 * Some dimensions may be initialized with an expression, but only in the array
 * type of an {@linkplain ASTArrayAllocation array allocation expression}.
 *
 * <pre class="grammar">
 *
