...
/**
 * Formal parameter node for a {@linkplain ASTFormalParameters formal parameter list}. This is distinct from
 * {@linkplain ASTLambdaParameter lambda parameters}.
 *
 * <p>
...
public final class ASTFormalParameter extends AbstractJavaNode implements ModifierOwner, TypeNode, VariableIdOwner {
    ...
    /**
     * Returns true if this node is a varargs parameter. Then, the type node is an {@link ASTArrayType ArrayType}, and
     * its last dimension {@linkplain ASTArrayTypeDim#isVarargs() is varargs}.
     */
     ...
     *
     * <p>
     * If this formal parameter is varargs, the type node is an {@link ASTArrayType}.
     */
