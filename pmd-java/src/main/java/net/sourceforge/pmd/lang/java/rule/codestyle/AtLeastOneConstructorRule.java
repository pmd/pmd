...
/**
 * This rule detects non-static classes with no constructors; requiring even the default constructor to be explicit. It
 * ignores classes with solely static methods, use {@link UseUtilityClassRule} to flag those.
 */
