...
/**
 * Represents the declaration of a type variable, ie a type parameter. Type
 * variables are reference types, but not class or interface types. They're also
 * not declared with the same node. For those reasons this type of references is
...
public interface JTypeParameterSymbol extends JTypeDeclSymbol, BoundToNode<ASTTypeParameter> {
    ...
    /**
     * Returns the {@link JClassSymbol} or {@link JMethodSymbol} which declared this
     * type parameter.
     */
    ...
    /**
     * Returns the upper bound of this type variable. This may be an intersection
     * type. If the variable is unbounded, returns Object.
     */
