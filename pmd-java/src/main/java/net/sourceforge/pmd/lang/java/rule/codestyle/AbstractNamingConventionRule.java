...
/**
 * Base class for naming conventions rule. Not public API, but used to uniformize eg property names between our rules.
 *
 * <p>
 * Protected methods may leak API because concrete classes are not final so they're package private instead
 *
