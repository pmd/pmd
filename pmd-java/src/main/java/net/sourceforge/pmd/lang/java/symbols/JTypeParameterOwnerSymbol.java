...
/**
 * Represents a declaration that can declare type parameters, {@literal i.e.}
 * {@link JClassSymbol} or {@link JMethodSymbol}.
 *
 * @since 7.0.0
 */
public interface JTypeParameterOwnerSymbol extends JAccessibleElementSymbol {
    ...
    /**
     * Returns the lexical scope of this symbol. This is little more than a map of
     * all the type parameters that are in scope at the point of this declaration,
     * indexed by their name. For example, for a method, this includes the type
     * parameters of the method, the type parameters of its enclosing class, and all
     * the other enclosing classes.
     */
    ...
    /**
     * Returns the {@link JClassSymbol#getEnclosingMethod() enclosing method} or the
     * {@link #getEnclosingClass() enclosing class}, in that order of priority.
     */
    @Nullable
