...
/**
 * A class literal. Class literals are {@linkplain ASTPrimaryExpression primary expressions}, but not proper
 * {@linkplain ASTLiteral literals}, since they are represented by several tokens.
 *
 * <pre class="grammar">
 *
