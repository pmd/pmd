...
public final class ASTConditionalExpression extends AbstractJavaExpr {
    ...
    /**
     * Returns the node that represents the guard of this conditional. That is the
    ...
    /**
     * Returns the node that represents the expression that will be evaluated if the
    ...
    /**
     * Note: this method is not used at all in pre-Java 8 analysis, because
     * standalone/poly exprs weren't formalized before java 8. Calling this method
     * then is undefined.
     */
    // very internal
