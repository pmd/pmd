 ...
 * declaration, e.g. {@link #hasModifiers(JModifier, JModifier...)
 * hasModifiers(JModifier.PUBLIC)} will always return true for a field declared
 * inside an interface, regardless of whether the {@code public} modifier was
 * specified explicitly or not. If you want to know whether the modifier was
 * explicitly stated, use
 * {@link #hasExplicitModifiers(JModifier, JModifier...)}.
 *
 * <p>
 * Modifiers are accessible from XPath through the functions
 * {@code pmd:modifiers()} and {@code pmd:explicitModifiers()}. They return a
 * sequence, e.g. {@code ("public", "static", "final")}.
 *
 * <p>
...
public interface ModifierOwner extends Annotatable {
     ...
     * {@link ASTModifierList#getEffectiveModifiers() effective modifiers}. Eg a
     * public method will have visibility {@link Visibility#V_PUBLIC public}, a
     * local class will have visibility {@link Visibility#V_LOCAL local}. There
     * cannot be any conflict with {@link #hasModifiers(JModifier, JModifier...)}}
     * on well-formed code (e.g. for any {@code n},
     * {@code (n.getVisibility() == V_PROTECTED) ==
     * n.hasModifiers(PROTECTED)})
     *
     * <p>
     * TODO a public method of a private class can be considered to be private we
     * could probably add another method later on that takes this into account
     */
     ...
     * visibility of its enclosing type declarations. For example, a public method
     * of a private class is "effectively private".
     *
     * <p>
     * Local declarations keep local visibility, eg a local variable somewhere in an
     * anonymous class doesn't get anonymous visibility.
     */
    ...
    /**
     * Returns true if this node has <i>all</i> the given modifiers either
     * explicitly written or inferred through context.
     */
    ...
    /**
     * Returns true if this node has <i>all</i> the given modifiers explicitly
    ...
    /**
     * Returns true if this node has the given visibility either explicitly written
     * or inferred through context.
     * 
     * @see #getVisibility()
     ...
     *
     * <p>
     * The ordering of the constants encodes a "contains" relationship, ie, given
     * two visibilities {@code v1} and {@code v2}, {@code v1 < v2} means that
     * {@code v2} is strictly more permissive than {@code v1}.
     */
    enum Visibility {
        ...
        /**
         * Confined to a local scope, eg method parameters, local variables, local
         * classes.
         */
        V_LOCAL("local"),
        ...
        V_PACKAGE("package"),
        /**
         * Package-private + visible to subclasses. Corresponds to modifier
         * {@link JModifier#PROTECTED}.
         */
