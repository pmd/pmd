 ...
 *
 * <p>
 * Record components declare a field, and if a canonical constructor is synthesized by the compiler, also a formal
 * parameter (which is in scope in the body of a {@linkplain ASTCompactConstructorDeclaration compact record
 ...
 * <li>The formal parameter symbol is accessible in the formal parameter list of the {@link JConstructorSymbol} for the
...
public final class ASTRecordComponent extends AbstractTypedSymbolDeclarator<JRecordComponentSymbol>
    ...
    /**
     * Returns true if this component's corresponding formal parameter in the canonical constructor of the record is
     * varargs. The type node of this component is in this case an {@link ASTArrayType}.
     */
