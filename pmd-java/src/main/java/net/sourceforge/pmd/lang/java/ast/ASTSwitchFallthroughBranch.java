...
/**
 * A fallthrough switch branch. This contains exactly one label, and zero or
 * more statements. Fallthrough must be handled by looking at the siblings. For
 * example, in the following, the branch for {@code case 1:} has no statements,
...
public final class ASTSwitchFallthroughBranch extends AbstractJavaNode implements ASTSwitchBranch {
    ...
    /**
     * Returns the list of statements dominated by the labels. This list is possibly
     * empty.
     */
