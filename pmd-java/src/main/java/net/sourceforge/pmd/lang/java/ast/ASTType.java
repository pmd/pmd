 ...
 *
 * <p>
 * Corresponds to the JLS's <a href="https://docs.oracle.com/javase/specs/jls/se11/html/jls-4.html#jls-Type">Type</a>
 * and <a href="https://docs.oracle.com/javase/specs/jls/se10/html/jls-8.html#jls-UnannType">UnannType</a> at the same
 * time. In some contexts this can also be an {@linkplain ASTIntersectionType intersection type}, though the JLS has no
 * production for that.
 *
 * <pre class="grammar">
 *
