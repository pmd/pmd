 ...
 */
public class AbstractJavaParserVisitorDecorator implements JavaParserVisitor {

    private final JavaParserVisitor javaParserVisitor;

    protected AbstractJavaParserVisitorDecorator(JavaParserVisitor javaParserVisitor) {
        this.javaParserVisitor = javaParserVisitor;
    }

    @Override
    public Object visit(JavaNode node, Object data) {
        return javaParserVisitor.visit(node, data);
    }
