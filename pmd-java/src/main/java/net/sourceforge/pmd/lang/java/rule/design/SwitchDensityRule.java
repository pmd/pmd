...
/**
 * Switch Density - This is the number of statements over the number of cases
 * within a switch. The higher the value, the more work each case is doing.
 *
 * <p>
 * Its my theory, that when the Switch Density is high, you should start looking
 * at Subclasses or State Pattern to alleviate the problem.
 * </p>
 *
...
public class SwitchDensityRule extends AbstractJavaRulechainRule {
    ...
    public Void visitSwitchLike(ASTSwitchLike node, Object data) {
        ...
        // note: if labelCount is zero, double division will produce +Infinity or NaN,
