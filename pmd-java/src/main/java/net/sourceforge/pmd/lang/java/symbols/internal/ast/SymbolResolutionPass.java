...
public final class SymbolResolutionPass {
    ...
    /**
     * Traverse the given compilation unit, creating symbols on all {@link SymbolDeclaratorNode}s.
     *
     * @param processor
     *            Processor
     * @param root
     *            Root node
     *
     * @return A symbol resolver for all encountered type declarations. This is used to avoid hitting the classloader
    ...
    /**
     * Converts between nodes to {@link SymAnnot}. Annotations that could not be converted, eg because they are written
     * with invalid code, are discarded.
     */
