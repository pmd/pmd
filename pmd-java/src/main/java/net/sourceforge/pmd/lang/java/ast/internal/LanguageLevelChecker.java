...
/**
 * Checks that an AST conforms to some language level. The reporting behaviour is parameterized with a
 * {@link ReportingStrategy}.
 *
 * @param <T>
...
public class LanguageLevelChecker<T> {
    ...
    /**
     * Those are just for the preview features. They are implemented in at least one preview language version. They
     * might be also be standardized.
     */
    private enum PreviewFeature implements LanguageFeature {
         ...
         *      (Java 21)
         * @see <a href="https://openjdk.org/jeps/463">JEP 463: Implicitly Declared Classes and Instance Main Methods
         *      (Second Preview)</a> (Java 22)
         * @see <a href="https://openjdk.org/jeps/477">JEP 477: Implicitly Declared Classes and Instance Main Methods
         *      (Third Preview)</a> (Java 23)
         ...
         * @see <a href="https://openjdk.org/jeps/482">JEP 482: Flexible Constructor Bodies (Second Preview)</a> (Java
         *      23)
         * @see <a href="https://openjdk.org/jeps/492">JEP 492: Flexible Constructor Bodies (Third Preview)</a> (Java
         *      24)
         */
         ...
         * @see <a href="https://openjdk.org/jeps/494">JEP 494: Module Import Declarations (Second Preview)</a> (Java
         *      24)
         */
         ...
         * 
         * @see <a href="https://openjdk.org/jeps/455">JEP 455: Primitive Types in Patterns, instanceof, and switch
         *      (Preview)</a> (Java 23)
         * @see <a href="https://openjdk.org/jeps/488">JEP 488: Primitive Types in Patterns, instanceof, and switch
         *      (Second Preview)</a> (Java 24)
         */
    ...
    private enum RegularLanguageFeature implements LanguageFeature {
         ...
         * @see <a href="https://bugs.openjdk.org/browse/JDK-8253374">JLS changes for Static Members of Inner
         *      Classes</a> (Java 16)
         */
         ...
         * @see <a href="https://openjdk.org/jeps/420">JEP 420: Pattern Matching for switch (Second Preview)</a> (Java
         *      18)
         * @see <a href="https://openjdk.org/jeps/427">JEP 427: Pattern Matching for switch (Third Preview)</a> (Java
         *      19)
         * @see <a href="https://openjdk.org/jeps/433">JEP 433: Pattern Matching for switch (Fourth Preview)</a> (Java
         *      20)
