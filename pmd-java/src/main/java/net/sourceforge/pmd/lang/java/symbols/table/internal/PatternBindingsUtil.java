 ...
 *
 * @see <a href=
 *      "https://docs.oracle.com/javase/specs/jls/se17/html/jls-6.html#jls-6.3.1">Java
...
final class PatternBindingsUtil {
    ...
    /**
     * Returns the binding set declared by the expression. Note that only some
     * expressions contribute bindings, and every other form of expression does not
     * contribute anything (meaning, all subexpressions are not processed).
     */
    static BindSet bindersOfExpr(ASTExpression e) {
        /*
         * JLS 17§6.3.1 If an expression is not a conditional-and expression,
    ...
    /**
     * A set of bindings contributed by a (boolean) expression. Different bindings
     * are introduced if the expr evaluates to false or true, which is relevant for
     * the scope of bindings introduced in if stmt conditions.
     */
