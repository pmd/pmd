...
public class EmptyControlStatementRule extends AbstractJavaRulechainRule {
    ...
    public Object visit(ASTFinallyClause node, Object data) {
        ...
        if (isEmpty(node.getBody())) {
            ctx.addViolationWithMessage(node, "Empty finally clause");
        }
        return null;
    }
    ...
    public Object visit(ASTSynchronizedStatement node, Object data) {
        RuleContext ctx = (RuleContext) data;
        if (isEmpty(node.getBody())) {
            ctx.addViolationWithMessage(node, "Empty synchronized statement");
        }
        return null;
    }
    ...
    public Object visit(ASTSwitchStatement node, Object data) {
        ...
        if (node.getNumChildren() == 1) {
            ctx.addViolationWithMessage(node, "Empty switch statement");
        }
        return null;
    }
    ...
    public Object visit(ASTBlock node, Object data) {
        ...
        if (isEmpty(node) && node.getParent() instanceof ASTBlock) {
            ctx.addViolationWithMessage(node, "Empty block");
        }
        return null;
    }
    ...
    public Object visit(ASTIfStatement node, Object data) {
        ...
        if (isEmpty(node.getThenBranch())) {
            ctx.addViolationWithMessage(node, "Empty if statement");
        }
        if (node.hasElse() && isEmpty(node.getElseBranch())) {
            ctx.addViolationWithMessage(node.getElseBranch(), "Empty else statement");
        }
        return null;
    }
    ...
    public Object visit(ASTWhileStatement node, Object data) {
        RuleContext ctx = (RuleContext) data;
        if (isEmpty(node.getBody())) {
            ctx.addViolationWithMessage(node, "Empty while statement");
        }
        return null;
    }
    ...
    public Object visit(ASTForStatement node, Object data) {
        RuleContext ctx = (RuleContext) data;
        if (isEmpty(node.getBody())) {
            ctx.addViolationWithMessage(node, "Empty for statement");
        }
        return null;
    }
    ...
    public Object visit(ASTForeachStatement node, Object data) {
        ...
        if (isEmpty(node.getBody())) {
            ctx.addViolationWithMessage(node, "Empty foreach statement");
        }
        return null;
    }
    ...
    public Object visit(ASTDoStatement node, Object data) {
        RuleContext ctx = (RuleContext) data;
        if (isEmpty(node.getBody())) {
            ctx.addViolationWithMessage(node, "Empty do..while statement");
        }
        return null;
    }
    ...
    public Object visit(ASTInitializer node, Object data) {
        RuleContext ctx = (RuleContext) data;
        if (isEmpty(node.getBody())) {
            ctx.addViolationWithMessage(node, "Empty initializer statement");
        }
        return null;
    }
    ...
    public Object visit(ASTTryStatement node, Object data) {
        ...
        if (isEmpty(node.getBody())) {
                ...
                for (ASTResource resource : resources) {
                    ...
                    if (localVarDecl == null) {
                        ...
                        if (isSimpleExpression(init)) {
                            ...
                            ctx.addViolationWithMessage(node, "Empty try-with-resources statement. Should be written {0}.close()", PrettyPrintingUtil.prettyPrint(init));
                            return null;
                        }
                    ...
                    if (!JavaRuleUtil.isExplicitUnusedVarName(name)) {
                        ctx.addViolationWithMessage(node, "Empty try-with-resources statement. Rename the resource to `ignored`, `unused` or `_` (Java 22+).");
                        return null;
                    }
                }
            }
            ...
            if (!hasResource) {
                ctx.addViolationWithMessage(node, "Empty try body");
            }
        }
        return null;
    }
