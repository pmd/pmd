...
/**
 * Represents the {@code extends} clause of a class or interface declaration. If the parent is an interface declaration,
 * then these types are all interface types. Otherwise, then this list contains exactly one element.
 *
 * <pre class="grammar">
 *
