...
/**
 * Utility class for type conversions, as defined in <a href=
 * "https://docs.oracle.com/javase/specs/jls/se10/html/jls-5.html">JLS§5</a>.
 */
...
public final class TypeConversion {
    ...
    /**
     * Performs <a href=
     * "https://docs.oracle.com/javase/specs/jls/se9/html/jls-5.html#jls-5.6.1">Unary
     * numeric promotion (JLS§5.6.1)</a>.
     * <p>
     ...
     * <li>Each operand, separately, of a shift operator &lt;&lt;, &gt;&gt;, or
     * &gt;&gt;&gt; (§15.19).
     * </ul>
     *
     * <p>
     * Returns {@link TypeSystem#ERROR} if the given type is not a numeric type,
     ...
     * <li>The addition and subtraction operators for numeric types + and -
     * (§15.18.2)
     * <li>The numerical comparison operators &lt;, &lt;=, &gt;, and &gt;=
     * (§15.20.1)
     ...
     * </ul>
     * <p>
     * Returns {@link TypeSystem#ERROR} if either of the parameters is not numeric.
     * This DOES NOT care for unresolved types.
     */
    ...
    /**
     * Is t convertible to s by boxing/unboxing/widening conversion? Only t can
     * undergo conversion.
     */
    ...
    /**
     * Is t convertible to s by boxing/unboxing conversion? Only t can undergo
     * conversion.
     */
    ...
    /**
     * Perform capture conversion on the type t. This replaces wildcards with fresh
     * type variables. Capture conversion is not applied recursively. Capture
     * conversion on any type other than a parameterized type (§4.5) acts as an
    ...
    public static JClassType capture(JClassType type) {
        ...
        // This is the algorithm described at
        ...
        for (int i = 0; i < typeArgs.size(); i++) {
            ...
            if (arg instanceof JWildcardType) {
                ...
                if (w.isUnbounded()) {
                    ...
                    // then Si is a fresh type variable whose upper bound is glb(Bi,
                    // Ui[A1:=S1,...,An:=Sn])
    ...
    /**
     * Returns true if the type is a parameterized class type, which has wildcards
     * as type arguments. Capture variables don't count.
     */
