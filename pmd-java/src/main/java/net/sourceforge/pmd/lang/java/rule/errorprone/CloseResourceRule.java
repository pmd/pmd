...
public class CloseResourceRule extends AbstractJavaRule {
    ...
    private static final String WRAPPING_TRY_WITH_RES_VAR_MESSAGE =
            "it is recommended to wrap resource ''{0}'' in try-with-resource declaration directly";
    private static final String REASSIGN_BEFORE_CLOSED_MESSAGE =
            "''{0}'' is reassigned, but the original instance is not closed";
    private static final String CLOSE_IN_FINALLY_BLOCK_MESSAGE =
    ...
    private static final InvocationMatcher FILESYSTEMS_GET_DEFAULT =
            InvocationMatcher.parse("java.nio.file.FileSystems#getDefault()");
