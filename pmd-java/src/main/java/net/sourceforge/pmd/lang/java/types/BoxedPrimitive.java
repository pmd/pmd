 ...
 *
 * <p>
 * Order of initialization is tricky since there is a circular dependency
 * between JPrimitiveType constants and their PrimitiveWrapper. The current
 * solution is to leak the 'this' instance in the enum constructor.
 */
final class BoxedPrimitive extends ClassTypeImpl {

    private final JPrimitiveType unboxed;

    // constructor called by JPrimitiveType, exactly once per type system and per
    // primitive
