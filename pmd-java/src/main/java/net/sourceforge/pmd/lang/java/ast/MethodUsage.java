...
/**
 * A node that uses another method or constructor. Those are {@link InvocationNode#getMethodType() InvocationNode}s and
...
public interface MethodUsage extends JavaNode {
    ...
    /**
     * Returns information about the overload selection for this call. Be aware, that selection might have failed
