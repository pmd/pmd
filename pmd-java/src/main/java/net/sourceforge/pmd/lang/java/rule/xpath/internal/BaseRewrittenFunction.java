...
/**
 * A context node test function that may parse its string argument early if it is a string literal.
 *
 * @param <S>
 *            Type of state into which the argument is parsed
 * @param <N>
 *            Type of node the function applies. The function will return false for other kinds of node.
 */
...
abstract class BaseRewrittenFunction<S, N extends Node> extends BaseJavaXPathFunction {
    ...
    /**
     * Parse the argument into the state. This is called at build time if the arg is constant, otherwise it's anyway
     * called before {@link #matches(Node, String, Object, boolean)} is called.
     */
     ...
     * @param parsedArg
     *            Result of {@link #parseArgument(String)} on the argument
     * @param isConstant
     *            Whether the argument is constant (it was parsed in all cases)
     *
     * @return Whether the function matches
     */
    protected abstract boolean matches(N contextNode, String arg, S parsedArg, boolean isConstant)
        ...
        return new FunctionCall() {
            ...
            public void staticInit(Object[] arguments) throws XPathFunctionException {
                if (arguments[0] instanceof String) {
                    ...
                    String name = (String) arguments[0]; // this expression has been type checked so there is an
                                                         // argument
            ...
            public Boolean call(Node node, Object[] arguments) throws XPathFunctionException {
                ...
                S parsedArg = isConstant ? constantState : parseArgument(arg);
