...
/**
 * Context of a usage reference ("in which class does the name occur?"), which
 * determines accessibility of referenced symbols. The context may have no
 * enclosing class, eg in the "extends" clause of a toplevel type.
 *
 * <p>
