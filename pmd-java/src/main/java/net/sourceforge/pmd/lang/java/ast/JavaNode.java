...
public interface JavaNode extends JjtreeNode<JavaNode> {
    ...
    /**
     * Returns the node representing the type declaration this node is found in. The
     * type of that node is the type of the {@code this} expression.
     *
     * <p>
     * This returns null for nodes that aren't enclosed in a type declaration. This
     * includes {@linkplain ASTPackageDeclaration PackageDeclaration}, This includes
    ...
    /**
     * Returns the type system with which this node was created. This is the object
     * responsible for representing types in the compilation unit.
     */
