...
public interface Classpath {
    ...
    /**
     * Returns a URL to load the given resource if it exists in this classpath. Otherwise returns null. This will
     * typically be used to find Java class files. A typical input would be {@code java/lang/String.class}.
     *
     * @param resourcePath
     *            Resource path, as described in {@link ClassLoader#getResource(String)}
     *
     ...
     * Every call to {@link #findResource(String)} is otherwise delegated to this one.
     *
    ...
    /**
     * Returns a classpath instance that uses {@link ClassLoader#getResourceAsStream(String)} to find resources.
     */
