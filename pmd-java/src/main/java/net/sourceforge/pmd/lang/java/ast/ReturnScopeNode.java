...
/**
 * Marker interface for those nodes that can be the target of a return statement. These delimit scopes for the control
 * flow. For instance the control flow in a lambda expression is distinct from that of the block it appears in: returns
