...
/**
 * Represents a record component. Record components are associated with a private final {@link JFieldSymbol} and a
 * public {@linkplain JMethodSymbol accessor method}.
 *
 * @since 7.3.0
 */
public interface JRecordComponentSymbol extends JAccessibleElementSymbol, BoundToNode<ASTRecordComponent> {
    ...
    /**
     * Record components use these modifiers by convention, although they cannot have explicit modifiers in source, and
     * the associated field and method symbol have different modifiers.
     */
