...
/**
 * The God Class Rule detects the God Class design flaw using metrics. A god
...
public class GodClassRule extends AbstractJavaRulechainRule {
    ...
    /**
     * Few means between 2 and 5. See: Lanza. Object-Oriented Metrics in Practice.
     * Page 18.
     */
    private static final int FEW_ATFD_THRESHOLD = 5;

    /**
     * One third is a low value. See: Lanza. Object-Oriented Metrics in Practice.
     * Page 17.
     */
