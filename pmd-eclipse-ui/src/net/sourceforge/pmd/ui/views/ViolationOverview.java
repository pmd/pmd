...
/**
 * A View for PMD-Violations, provides an Overview as well as statistical Information
 * 
...
public class ViolationOverview extends ViewPart implements IDoubleClickListener, ISelectionChangedListener, ISelectionProvider {
    ...
    /**
     * Creates the initial Input In General this is a RootRecord for the WorkspaceRoot
     * 
    ...
    /**
     * Gets the Violations that are filtered, meaning, if e.g. the Priorities 4 and 5 are filtered, this Function returns the Number
     * of all Priority 1,2 and 3-Markers
     * 
     * @param element
     ...
     * 
     * @return true, if only Files should be seen, false if Packages and Files should be displayed
     */
     ...
     * 
     * @param properties, an Array with Properties, the First Value is the Number of the sorted Column, the Second one is the
     *        Direction (-1 or 1)
     */
