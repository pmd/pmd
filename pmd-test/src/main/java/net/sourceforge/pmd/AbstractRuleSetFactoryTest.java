...
public abstract class AbstractRuleSetFactoryTest {
    ...
    private void testRuleSet(String fileName)
        ...
        RuleSet ruleSet2 = new RuleSetParser().parseFromResource(createRuleSetReferenceId(xml2));
        ...
        RuleSet ruleSet3 = new RuleSetParser().parseFromResource(createRuleSetReferenceId(xml3));
