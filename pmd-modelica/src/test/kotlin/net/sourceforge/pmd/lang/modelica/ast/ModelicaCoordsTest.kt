...
package TestPackage
  package EmptyPackage
      ...
      """
                .trim()
                .parseModelica() should
                matchNode<ASTStoredDefinition> {
                    it shouldHaveText
                        """package TestPackage
  package EmptyPackage
  end EmptyPackage;
                                                ...
                                                child<ASTClassSpecifier> {
                                                    ...
                                                    child<ASTSimpleLongClassSpecifier> {
                                                        ...
                                                        child<ASTComposition> {
                                                            ...
                                                            child<ASTElementList> {
                                                                it shouldHaveText ""
                                                                it.firstToken::isImplicit shouldBe
                                                                    true
                                                                it.lastToken shouldBe it.firstToken
...
fun String.parseModelica(): ASTStoredDefinition = ModelicaParsingHelper.DEFAULT.parse(this)
