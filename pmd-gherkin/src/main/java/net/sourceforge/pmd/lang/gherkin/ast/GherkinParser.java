...
public class GherkinParser extends Parser {
    ...
    public static final int BOMUTF8 = 1,
            BOMUTF16 = 2,
            WHITESPACE = 3,
            COMMENT = 4,
            STARTCOMMENT = 5,
    ...
    public static final int RULE_main = 0,
            RULE_feature = 1,
            RULE_instructionLine = 2,
            RULE_instruction = 3,
            RULE_stepInstruction = 4,
            RULE_background = 5,
            RULE_rulex = 6,
            RULE_scenario = 7,
            RULE_scenarioOutline = 8,
            RULE_step = 9,
            RULE_stepItem = 10,
            RULE_tagline = 11,
            RULE_and = 12,
            ...
            RULE_when = 18,
            RULE_examples = 19,
            RULE_instructionDescription = 20,
            RULE_stepDescription = 21,
            RULE_description = 22,
            RULE_text = 23;
    ...
    public static class MainContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(GherkinParser.EOF, 0);
        }

        public TerminalNode STARTCOMMENT() {
            return getToken(GherkinParser.STARTCOMMENT, 0);
        }
        ...
        public List<TerminalNode> NL() {
            return getTokens(GherkinParser.NL);
        }
    ...
    public static class FeatureContext extends ParserRuleContext {
        ...
        public TerminalNode FEATURE() {
            return getToken(GherkinParser.FEATURE, 0);
        }
    ...
    public static class InstructionLineContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitInstructionLine(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class InstructionContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitInstruction(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StepInstructionContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitStepInstruction(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BackgroundContext extends ParserRuleContext {
        public TerminalNode BACKGROUND() {
            return getToken(GherkinParser.BACKGROUND, 0);
        }
    ...
    public static class RulexContext extends ParserRuleContext {
        public TerminalNode RULEX() {
            return getToken(GherkinParser.RULEX, 0);
        }
    ...
    public static class ScenarioContext extends ParserRuleContext {
        public TerminalNode SCENARIO() {
            return getToken(GherkinParser.SCENARIO, 0);
        }
    ...
    public static class ScenarioOutlineContext extends ParserRuleContext {
        public TerminalNode SCENARIOOUTLINE() {
            return getToken(GherkinParser.SCENARIOOUTLINE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitScenarioOutline(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TaglineContext extends ParserRuleContext {
        public List<TerminalNode> TAG() {
            return getTokens(GherkinParser.TAG);
        }
    ...
    public static class AndContext extends ParserRuleContext {
        public TerminalNode AND() {
            return getToken(GherkinParser.AND, 0);
        }
    ...
    public static class AnystepContext extends ParserRuleContext {
        public TerminalNode ANYSTEP() {
            return getToken(GherkinParser.ANYSTEP, 0);
        }
    ...
    public static class ButContext extends ParserRuleContext {
        public TerminalNode BUT() {
            return getToken(GherkinParser.BUT, 0);
        }
    ...
    public static class DatatableContext extends ParserRuleContext {
        public List<TerminalNode> DATATABLE() {
            return getTokens(GherkinParser.DATATABLE);
        }
    ...
    public static class GivenContext extends ParserRuleContext {
        public TerminalNode GIVEN() {
            return getToken(GherkinParser.GIVEN, 0);
        }
    ...
    public static class ThenContext extends ParserRuleContext {
        public TerminalNode THEN() {
            return getToken(GherkinParser.THEN, 0);
        }
    ...
    public static class WhenContext extends ParserRuleContext {
        public TerminalNode WHEN() {
            return getToken(GherkinParser.WHEN, 0);
        }
    ...
    public static class ExamplesContext extends ParserRuleContext {
        public TerminalNode EXAMPLES() {
            return getToken(GherkinParser.EXAMPLES, 0);
        }
    ...
    public static class InstructionDescriptionContext extends ParserRuleContext {
        ...
        public TerminalNode PARAMETER() {
            return getToken(GherkinParser.PARAMETER, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_instructionDescription;
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitInstructionDescription(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StepDescriptionContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitStepDescription(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DescriptionContext extends ParserRuleContext {
        ...
        public TerminalNode TAG() {
            return getToken(GherkinParser.TAG, 0);
        }
        ...
        public TerminalNode DATATABLE() {
            return getToken(GherkinParser.DATATABLE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitDescription(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TextContext extends ParserRuleContext {
        public List<TerminalNode> TOKEN() {
            return getTokens(GherkinParser.TOKEN);
        }
    ...
    public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\32\u0108\4\2\t\2"
