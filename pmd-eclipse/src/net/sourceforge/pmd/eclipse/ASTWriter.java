...
/**
 * Interface of an AST Writer. An ASTWriter is an object used to "serialize" an
 * AST.
 * 
...
public interface ASTWriter {
	 ...
	 * @throws PMDEclipseException
	 */
    void write(OutputStream outputStream, ASTCompilationUnit compilationUnit) throws PMDEclipseException;
