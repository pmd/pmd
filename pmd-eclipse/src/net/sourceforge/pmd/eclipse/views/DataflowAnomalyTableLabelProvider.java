...
public class DataflowAnomalyTableLabelProvider implements ITableLabelProvider {
	...
	public Image getColumnImage(Object element, int columnIndex) {
		...
		if (columnIndex == 0) {
			return PMDPlugin.getDefault().getImage(
				KEY_IMAGE_DFA, PMDPlugin.ICON_LABEL_ERR_DFA);
		}
		return null;
	}
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		switch(columnIndex) {
			...
			case 0: return marker.getAttribute(IMarker.MESSAGE, "");
			...
			case 1:
				...
				return line1+", "+line2;
			// show the Variable
			case 2: return marker.getAttribute(
				PMDPlugin.KEY_MARKERATT_VARIABLE, "");
			// show the File
			case 3: return marker.getResource().getName();
		}
