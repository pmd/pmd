...
import net.sourceforge.pmd.eclipse.views.actions.QuickFixAction;
import net.sourceforge.pmd.eclipse.views.actions.RemoveViolationAction;
import net.sourceforge.pmd.eclipse.views.actions.ReviewAction;
import net.sourceforge.pmd.eclipse.views.actions.ShowRuleAction;
...
public class ViolationOutline extends PageBookView implements ISelectionProvider {
	...
	public void init(IViewSite site) throws PartInitException {
		...
		memento = new ViewMemento(PMDPlugin.MEMENTO_OUTLINE_FILE);
	...
	public void dispose() {
		...
		memento.save(PMDPlugin.MEMENTO_OUTLINE_FILE);
	...
	protected IPage createDefaultPage(PageBook book) {
		...
		page.setMessage(PMDPlugin.getDefault().getMessage( 
			PMDConstants.MSGKEY_VIEW_OUTLINE_DEFAULT_TEXT ));
		return page;
	}
	...
	protected PageRec doCreatePage(IWorkbenchPart part) {
		if (resourceRecord != null) {
			...
			ViolationOutlinePage page = 
				new ViolationOutlinePage(resourceRecord, this);
	...
	protected void doDestroyPage(IWorkbenchPart part, PageRec pageRecord) {
		ViolationOutlinePage page = 
			(ViolationOutlinePage) pageRecord.page;
		...
		if (page != null) {
			...
			memento.save(PMDPlugin.ID_OUTLINE);
			page.dispose();
		}
	...
	private void createDropDownMenu() {
		...
		for (int k=0; k<priorities.length; k++) {
			Action filterAction = 
				new PriorityFilterAction(priorities[k], this);
	...
	public void createContextMenu(final TableViewer viewer) {
		...
		manager.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				...
				Action showRuleAction = 
					new ShowRuleAction(viewer, getSite().getShell());
				...
				// Remove Violation
				RemoveViolationAction removeAction = 
					new RemoveViolationAction(viewer);
