...
public class TextColumnDescriptor extends AbstractRuleColumnDescriptor {
	...
	public static final RuleColumnDescriptor maxLangVers  = new TextColumnDescriptor(StringKeys.MSGKEY_PREF_RULESET_COLUMN_MAX_VER, 	SWT.LEFT, 30, RuleFieldAccessor.maxLanguageVersion, false, null);
	...
	public static final RuleColumnDescriptor modCount  	  = new TextColumnDescriptor(StringKeys.MSGKEY_PREF_RULESET_COLUMN_MODCOUNT,    SWT.RIGHT, 25, RuleFieldAccessor.nonDefaultProperyCount, false, null);
