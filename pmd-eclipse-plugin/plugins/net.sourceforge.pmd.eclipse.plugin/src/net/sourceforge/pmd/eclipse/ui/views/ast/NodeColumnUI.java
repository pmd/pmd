...
public interface NodeColumnUI {
	...
	ItemFieldAccessor<String, Node> typeNameAcc = new ItemFieldAccessorAdapter<String, Node>() {
		public String valueFor(Node node) {	return node.toString(); }
	};
	
	ItemFieldAccessor<String, Node> imageAcc = new ItemFieldAccessorAdapter<String, Node>() {
		public String valueFor(Node node) {	return node.getImage(); }
	};

	ItemFieldAccessor<Integer, Node> beginLineNumAcc = new ItemFieldAccessorAdapter<Integer, Node>() {
		public Integer valueFor(Node node) { return node.getBeginLine(); }
	};
	
	ItemFieldAccessor<Integer, Node> endLineNumAcc = new ItemFieldAccessorAdapter<Integer, Node>() {
		public Integer valueFor(Node node) { return node.getEndLine(); }
	};
	
	ItemFieldAccessor<Integer, Node> beginColumnAcc = new ItemFieldAccessorAdapter<Integer, Node>() {
		public Integer valueFor(Node node) { return node.getBeginColumn(); }
	};
	
	ItemFieldAccessor<Integer, Node> endColumnAcc = new ItemFieldAccessorAdapter<Integer, Node>() {
		public Integer valueFor(Node node) { return node.getEndColumn(); }
	};
	
	ItemFieldAccessor<String, Node> derivedAcc = new ItemFieldAccessorAdapter<String, Node>() {
		public String valueFor(Node node) { return NodeImageDeriver.derivedTextFor(node); }
	};	
	
	ItemFieldAccessor<String, Node> imageOrDerivedAcc = new ItemFieldAccessorAdapter<String, Node>() {
