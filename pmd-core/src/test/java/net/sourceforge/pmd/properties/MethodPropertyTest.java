...
import net.sourceforge.pmd.lang.rule.properties.ValueParsers;
...
public class MethodPropertyTest extends AbstractPackagedPropertyDescriptorTester<Method> {
    ...
    public void testAsStringOn() {
        ...
        for (int i = 0; i < METHOD_SIGNATURES.length; i++) {
            method = ValueParsers.METHOD_PARSER.valueOf(METHOD_SIGNATURES[i]);
    ...
    public void testAsMethodOn() {
        ...
        for (int i = 0; i < METHOD_SIGNATURES.length; i++) {
            methods[i] = ValueParsers.METHOD_PARSER.valueOf(METHOD_SIGNATURES[i]);
