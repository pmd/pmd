...
public final class XmlErrorMessages {
    ...
    public static final String IGNORED__DUPLICATE_CHILD_ELEMENT =
            "Duplicated child with name ''{0}''" + THIS_WILL_BE_IGNORED;
    public static final String IGNORED__DUPLICATE_PROPERTY_SETTER =
            "Duplicate property tag with name ''{0}''" + THIS_WILL_BE_IGNORED;
    public static final String IGNORED__PROPERTY_CHILD_HAS_PRECEDENCE =
            "Both a ''value'' attribute and a child element are present, the attribute will be ignored";

    public static final String ERR__UNSUPPORTED_VALUE_ATTRIBUTE =
            "This property does not support the attribute syntax.\nUse a nested element, e.g. {1}";
    ...
    public static final String ERR__INVALID_VERSION_RANGE =
            "Invalid language version range, minimum version ''{0}'' is greater than maximum version ''{1}''";
    public static final String ERR__INVALID_LANG_VERSION_NO_NAMED_VERSION =
            "Invalid language version ''{0}'' for language ''{1}'', the language has no named versions";
    public static final String ERR__INVALID_LANG_VERSION =
            "Invalid language version ''{0}'' for language ''{1}'', supported versions are {2}";

    public static final String WARN__DEPRECATED_USE_OF_ATTRIBUTE =
            "The use of the ''{0}'' attribute is deprecated. Use a nested element, e.g. {1}";
    public static final String ERR__INVALID_PRIORITY_VALUE =
    ...
    public static final String WARN__DELIMITER_DEPRECATED =
