...
public final class XmlUtil {
    ...
    public static Stream<Element> getElementChildrenNamedReportOthers(
            Element parent, Set<SchemaConstant> names, PmdXmlReporter err) {
    ...
    public static void reportIgnoredUnexpectedElt(
            Element parent, Element unexpectedChild, Set<SchemaConstant> names, PmdXmlReporter err) {
        err.at(unexpectedChild)
                .warn(
    ...
    public static List<Element> getChildrenExpectSingleName(Element elt, String name, PmdXmlReporter err) {
        return XmlUtil.getElementChildren(elt)
                .peek(it -> {
    ...
    public static Element getSingleChildIn(
            Element elt, boolean throwOnMissing, PmdXmlReporter err, Set<SchemaConstant> names) {
