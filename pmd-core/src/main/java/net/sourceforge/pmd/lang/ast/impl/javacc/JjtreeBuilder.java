...
public final class JjtreeBuilder<N extends AbstractJjtreeNode<?>> {
    ...
    public void closeNodeScope(N n, final int num, JavaccToken lastToken) {
        ...
        while (i-- > 0) {
            child = popNode();
            addChild((AbstractJjtreeNode<?>) n, child, i);
        }
    ...
    public void closeNodeScope(N n, boolean condition, JavaccToken lastToken) {
        if (condition) {
            ...
            mk = marks.remove(marks.size() - 1);
            while (a-- > 0) {
                addChild((AbstractJjtreeNode<?>) n, popNode(), a);
            }
            closeImpl(n, lastToken);
        } else {
            mk = marks.remove(marks.size() - 1);
    ...
    // captures the type parameter
    @SuppressWarnings("unchecked")
    private <T extends Node> void addChild(AbstractJjtreeNode<T> parent, N child, int idx) {
        parent.addChild((T) child, idx);
    }
