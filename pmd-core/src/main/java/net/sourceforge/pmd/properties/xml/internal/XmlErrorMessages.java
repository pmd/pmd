...
public final class XmlErrorMessages {
    ...
    public static final String IGNORED_UNEXPECTED_CHILD_ELEMENT = "Unexpected element '{0}', expecting only '{1}', this will be ignored";
    public static final String IGNORED_DUPLICATE_CHILD_ELEMENT = "Expecting a single '{0}' child, this will be ignored";

    public static final String DUPLICATE_PROPERTY_SETTER = "Duplicate property tag for name '{0}', this will be ignored";
    public static final String PROPERTY_DOES_NOT_EXIST = "Cannot set non-existent property '{0}' on rule '{1}', known properties are {2}";
    public static final String PROPERTY_DOESNT_SUPPORT_VALUE_ATTRIBUTE = "This property does not support the attribute syntax.\nUse a nested element, e.g. {1}";
