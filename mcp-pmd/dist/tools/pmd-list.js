...
exports.pmdListRulesetsTool = exports.pmdListLanguagesTool = void 0;
exports.executeListLanguages = executeListLanguages;
exports.executeListRulesets = executeListRulesets;
const pmd_executor_js_1 = require("../pmd-executor.js");
/**
 * Execute list languages tool
 */
async function executeListLanguages() {
    const pmdLanguages = await pmd_executor_js_1.pmdExecutor.listLanguages();
    const cpdLanguages = await pmd_executor_js_1.pmdExecutor.listCpdLanguages();
    const lines = [
 ...
 */
async function executeListRulesets(language) {
    // Common rulesets by language
    const rulesetsByLanguage = {
        java: [
 ...
 */
exports.pmdListLanguagesTool = {
    name: 'pmd_list_languages',
    description: 'List all programming languages supported by PMD for static analysis and copy-paste detection.',
    inputSchema: {
        type: 'object',
        properties: {},
        required: [],
...
exports.pmdListRulesetsTool = {
    name: 'pmd_list_rulesets',
    description: 'List available PMD rulesets for code analysis. Optionally filter by language.',
    inputSchema: {
        type: 'object',
        properties: {
            language: {
                type: 'string',
                description: 'Filter rulesets by language (e.g., "java", "ecmascript", "apex"). If not specified, shows all languages.',
            },
        },
        required: [],
    },
};
//# sourceMappingURL=pmd-list.js.map